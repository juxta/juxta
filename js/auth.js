define(['juxta', 'modal'], function (Juxta, Modal) {
     ...
     */
    function Auth(element, request) {

        Modal.prototype.constructor.call(this, element, {closable: false});
    ...
    Auth.prototype = Object.create(Modal.prototype);
     ...
     * @return {Auth}
     */
    Auth.prototype.show = function (id) {
        //
        ...
        this._request.send({
            action: {get: 'connections'}, context: this, success: function (response) {
                this._getConnectionsCallback(response, id);
            }
        });
     ...
     */
    Auth.prototype._loginCallback = function (response) {
        //
     ...
     * @param {Number} id
     */
    Auth.prototype._getConnectionsCallback = function (response, id) {
        //
     ...
     * @return {Auth}
     */
    Auth.prototype.fill = function (connection) {
        //
        if (connection) {
