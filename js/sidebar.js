define(function () {
     ...
     * @class Sidebar
     */
    function Sidebar(element, connection) {
        ...
        this._connection.on('change', (function () {
            this.setPath(this._connection.get());
        }).bind(this));
     ...
     */
    Sidebar.prototype.restore = function () {
        this._container
     ...
     * @param {Object} path
     */
    Sidebar.prototype.highlight = function (link, path) {
        //
        clearTimeout(this._timer);
     ...
     * @param {Object}
     */
    Sidebar.prototype.setPath = function (path) {
        //
     ...
     * Fix links
     */
    Sidebar.prototype.repairLinks = function () {
        //
        var path = this._path;
