define(function () {
     ...
     * @param {Object} options
     */
    Notification.prototype.hide = function (element, options) {
        //
        this._load = null;

        if (arguments.length == 2) {
            element.delay(options.delay).slideUp(options.hideSpeed, function () {
                $(this).remove();
            });
     ...
     * @return {jQuery}
     */
    Notification.prototype.loading = function (message, options) {
        //
