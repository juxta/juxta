define(['window', 'grid2'], function (Frame, Grid2) {
     ...
     */
    function Table(element, request) {

        Frame.prototype.constructor.call(this, element, {
            closable: false,
            mazimized: false,
            menu: {'Browse Table': null},
            cache: 3600
        });
         ...
         * @type {Grid2}
         */
        this._columns = new Grid2(this.find('.grid2'));
    ...
    Table.prototype = Object.create(Frame.prototype);
     ...
     */
    Table.prototype._stretch = function () {
        //
        var height = 0;
     ...
     * @return {jqXHR}
     */
    Table.prototype.edit = function (params) {
        this.show(
            {
     ...
     * @return {jqXHR}
     */
    Table.prototype._requestShowTable = function (params) {
        //
     ...
     * @private
     */
    Table.prototype._responseShowTable = function (response) {
        //
     ...
     * @return {jqXHR}
     */
    Table.prototype._requestIndexes = function (params) {
        var request;
        ...
        request = {
            ...
            success: (function (response) {
                this._columns.disableSelectRows().fill(response);
                this.ready();
            }).bind(this)
        };
     ...
     * @return {jqXHR}
     */
    Table.prototype._requestShowForeign = function (params) {
        var request;
     ...
     * @type {Object}
     */
    Table.prototype._rightMenuOptions = {
        columns: {
            'Columns': null,
