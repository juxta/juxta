define(['events', 'grid2contextmenu'], function (Events, ContextMenu) {
    ...
    Grid2.prototype = Object.create(Events.prototype);
     ...
     * @return {Grid2}
     */
    Grid2.prototype.setHeight = function (height) {
        //
     ...
     * @return {Boolean}
     */
    Grid2.prototype.prepare = function (params, context) {
        //
        if (!params) {
            return false;
        }
        ...
        if (params.row) {
            ...
            $.each(this._columns, (function (i, column) {
                this._rowTemplate += '<td>{' + column.name + '}</td>';
            }).bind(this));
            this._rowTemplate += '</tr>';
        }
     ...
     * @param {Object} extra
     */
    Grid2.prototype.fill = function (data, params, extra) {
        //
     ...
     * @return {Grid2}
     */
    Grid2.prototype.empty = function () {
        //
        this._body.empty();
     ...
     *
     */
    Grid2.prototype.clear = function () {
        //
        this.empty();
        this._head.empty();
     ...
     *
     */
    Grid2.prototype.enableSelectRows = function () {
        //
     ...
     *
     */
    Grid2.prototype.disableSelectRows = function () {
        //
     ...
     * @return {Boolean}
     */
    Grid2.prototype.vertScrollEnabled = function () {
        return this._bodyContainer.height() < this._body.height();
    };

    Grid2.prototype.is = function () {
        return $.fn.is.apply(this._container, arguments);
    };

    Grid2.prototype.show = function () {
        this._container.show();
    };

    Grid2.prototype.hide = function () {
     ...
     */
    Grid2.prototype.remove = function (rows) {
        //
     ...
     * @ return {Array|Object}
     */
    Grid2.prototype.getSelected = function () {
        //
        var rows = [],
            rowsByType = {};
     ...
     * @return {Grid2}
     */
    Grid2.prototype.deselectAll = function () {
        //
     ...
     * @return jQuery
     */
    Grid2.prototype.getRowsByName = function (names) {
